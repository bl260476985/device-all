...
namespace App\Http\Controllers\Admin\V1\Index;
...
class IndexDeviceController extends Controller
{
    ...
    public function mapSearch(Request $req)
    {
        ...
        $stationinfos = DB::table('station')->select('id', 'name', 'longitude', 'latitude', 'province', 'city', 'district', 'address')
        ...
        return $this->success($stationinfos);
    }
